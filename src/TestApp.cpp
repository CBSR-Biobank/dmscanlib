...
CSimpleOptA::SOption longOptions[] = {
                ...
                { 'd', "--decode", SO_NONE }, { 'd', "-d", SO_NONE }, {
                                OPT_ID_DEBUG, "--debug", SO_REQ_SEP },
                { OPT_ID_DEBUG_FILE, "--debugfile", SO_NONE }, { OPT_ID_DPI,
                                                                 "--dpi",
                                                                 SO_REQ_SEP },
                { OPT_ID_GAP, "--gap", SO_REQ_SEP }, { OPT_ID_VERTICAL,
                                                       "--vertical", SO_NONE },
                { 'v', "-v", SO_NONE }, { 'h', "--help", SO_NONE }, { 'h',
                                                                      "--h",
                                                                      SO_NONE },
                { 'i', "--input", SO_REQ_SEP }, { 'i', "-i", SO_REQ_SEP }, {
                                'p', "--plate", SO_REQ_SEP },
                { 'p', "-p", SO_REQ_SEP }, { 'o', "--output", SO_REQ_SEP }, {
                                'o', "-o", SO_REQ_SEP },
                { 's', "--scan", SO_NONE }, { 's', "-s", SO_NONE }, {
                ...
                { OPT_ID_THRESHOLD, "--threshold", SO_REQ_SEP }, { OPT_ID_LEFT,
                                                                   "--left",
                                                                   SO_REQ_SEP },
                { OPT_ID_TOP, "--top", SO_REQ_SEP }, { OPT_ID_RIGHT, "--right",
                                                       SO_REQ_SEP },
                { OPT_ID_BOTTOM, "--bottom", SO_REQ_SEP }, { OPT_ID_FLATBED,
                                                             "--flatbed",
                                                             SO_NONE },
                { 'l', "-l", SO_REQ_SEP }, { 't', "-t", SO_REQ_SEP }, {
                                'r', "-r", SO_REQ_SEP },
                { OPT_ID_OUTPUTBARCODES, "--outputBarcodes", SO_NONE }, {
                                'b', "-b", SO_REQ_SEP },
                { 'f', "-f", SO_NONE }, SO_END_OF_OPTIONS };
...
TestApp::TestApp(int argc, char ** argv) {
    ...
    dmScanLib = std::tr1::shared_ptr<DmScanLib>(
                    new DmScanLib(options.debugLevel, options.debugfile));
